...
| 2026-09-21 | `feature/mcx-crude-spike` | C1: session profiles, MCX instruments/options/costs, `trading-bot-mcx.service` + `mcx.env` (disabled), `ensure_mcx_db.sh`, pgdump of both databases |
